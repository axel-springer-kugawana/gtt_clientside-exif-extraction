...
//
// Available methods:
// getThumbnail(callback) - Returns image of exif thumbnail or null if not available
// getEXIFData(callback) - Returns json object with all available exif data or null if not available
// getGeoCoordinates(callback) - Returns json object with latitude,longitude or null if not available
